...
const MATRIX: Partial<Record<CareerArea, Partial<Record<CareerArea, Recommendation>>>> = {
    ...
    Sociales: {
        Sociales: {
            ...
            psychologicalAdvice: "Tu perfil **\"Social\"** 👥 refleja empatía, cooperación y orientación al servicio. Te motiva ayudar, enseñar y trabajar en equipo para mejorar la vida de los demás.",
