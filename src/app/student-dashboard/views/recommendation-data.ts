...
// MATRIX con todas las combinaciones y sus recomendaciones (sin tildes)
const MATRIX: Record<string, Recommendation> = {
    ...
    'ingenierias — sociales': {
        ...
        psychologicalAdvice: "El perfil 'Realista' se orienta a lo técnico, pero puede adaptarse a la planificación y coordinación. Disfrutas aplicar métodos y ver resultados en contextos con impacto social.",
    ...
    'ingenierias — biomedicas': {
        ...
        psychologicalAdvice: "El perfil 'Realista-Investigador' combina precisión técnica y curiosidad científica. Te motiva aplicar la ingeniería al cuidado y bienestar humano.",
    ...
    'sociales — biomedicas': {
        ...
        psychologicalAdvice: "El perfil 'Social' muestra empatía y vocación de servicio. Te sientes realizado ayudando a otros en temas de salud o bienestar.",
...
/**
 * Devuelve la recomendación basada en la combinación completa de TEST vs NOTAS
 * Normaliza cadenas para evitar errores por tildes o mayúsculas
 * @param combination Ejemplo: "Ingenierías — Sociales"
 */
export function getRecommendation(combination: string): Recommendation {
